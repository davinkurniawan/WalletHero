...
ALTER TABLE "user" ADD CONSTRAINT "user_fk0" FOREIGN KEY ("status_id") REFERENCES "status"("id");
...
ALTER TABLE "goal" ADD CONSTRAINT "goal_fk0" FOREIGN KEY ("user_id") REFERENCES "user"("id");
